...
def mcp_error_handler(label: str):
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            try:
                ...
                return f"Error retrieving {label} data: {str(e)}"
        return wrapper
    return decorator


@mcp.tool()
@mcp_error_handler("marginal fuel")
...
@mcp.tool()
@mcp_error_handler("hourly load forecast")
...
@mcp.tool()
@mcp_error_handler("seven day forecast")
